          ...
          <div className="sticky top-28 bg-white border border-[var(--ink)] rounded-2xl p-6 space-y-4 shadow-[5px_5px_0_var(--ink)]">
            ...
            {l.seller_phone && (
              <a
                ...
                className="w-full flex items-center justify-center gap-2 h-11 border border-[var(--ink)] rounded-full bg-transparent text-[var(--ink)] text-sm font-medium hover:bg-[var(--ink)] hover:text-white transition-colors"
              >
            ...
            {whatsappLink && (
              <a
                ...
                className="w-full flex items-center justify-center gap-2 h-11 border border-[var(--ink)] rounded-full bg-[var(--ink)] text-white text-sm font-medium hover:bg-white hover:text-[var(--ink)] transition-colors"
              >
