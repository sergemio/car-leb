      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 pt-8 pb-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 shrink-0">
            <button
              type="button"
              className="inline-flex items-center gap-2 px-4 h-10 rounded-lg border border-[var(--gray-2)] bg-white text-[13px] font-medium text-[var(--ink)] hover:bg-[var(--gray-1)] transition-colors"
            >
